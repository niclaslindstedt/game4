...
| `cliffs.ts` | **The cliffs (R22):** a level shelf out of the country, a sheer face, a landing apron falling away below it — stood on a slope facing down it, clear of the track, the kickers, the rim and the ice, off a stream of its own. `onCliff` is what the forest keeps off. |
