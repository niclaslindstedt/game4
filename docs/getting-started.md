...
- **TIME** — **MORNING**, **DAY**, **EVENING** or **NIGHT**, worked out on that date at that map's latitude — a morning in December is late and short, one in April early. Night rides under the moon and the stars by the headlamp. It stands on **AS DEALT**, the map's own hour, until moved. The sun moves on from there an hour every ten minutes of riding.
- **WEATHER** — the map's own sky, or clear, fair, high cloud, overcast, falling snow or a valley fog.
