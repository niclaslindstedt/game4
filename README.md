...
| `make blender`          | A game asset modelled in Blender off the game's own data: studio renders, the game-budget glTF with two LODs, the `.blend` — never committed (`KIND=sled`, `ID=ibex`, `ARGS=--quality=game`; needs Blender)                                                                                                           |
