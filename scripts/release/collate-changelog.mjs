...
import { TYPES, FRAG_DIR, listFragmentFiles, parseFragment } from "./fragments.mjs";
...
const replaced = orig.replace(/## \[Unreleased\]\s*\n/, `## [Unreleased]\n\n${section}\n`);
if (replaced === orig) {
...
console.log(`Wrote ${VERSION} to CHANGELOG.md from ${files.length} fragment(s).`);
