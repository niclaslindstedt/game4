...
//       maps R18 deals an EVENING, which start instead `sun.evening`
...
//   R18 THE WEATHER. Every map is dealt one sky off a stream of its own —
...
export const LEVEL_RULES = {
  ...
  sun: {
    ...
    minElevation: 5,
    /** An evening start (R18), hours from sunset: half an hour of low sun
