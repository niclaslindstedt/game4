...
export const SLED: SledSpec = {
  ...
  front: { rate: 6000, bump: 370, rebound: 830, travel: 0.23 },
  rear: { rate: 2900, bump: 185, rebound: 400, travel: 0.3 },
  powerKw: 123,
  peakRpm: 7900,
  maxRpm: 8400,
  idleRpm: 1500,
...
export const HARE: SledSpec = {
  ...
  lugHeight: 0.032,
  studs: 96,
  front: { rate: 6400, bump: 400, rebound: 760, travel: 0.25 },
  rear: { rate: 3100, bump: 200, rebound: 440, travel: 0.33 },
  engageRpm: 3300,
  gearTop: 53,
  cdA: 0.86,
  topSpeed: 172,
...
export const IBEX: SledSpec = {
  ...
  treadRear: -1.36,
  lugHeight: 0.076,
  front: { rate: 5200, bump: 320, rebound: 770, travel: 0.21 },
  rear: { rate: 2700, bump: 170, rebound: 380, travel: 0.27 },
  powerKw: 134,
  engageRpm: 4200,
  gearTop: 43,
  skiLock: 0.55,
...
export const STOAT: SledSpec = {
  ...
  lugHeight: 0.041,
  studs: 144,
  front: { rate: 7400, bump: 560, rebound: 950, travel: 0.28 },
  rear: { rate: 3700, bump: 290, rebound: 560, travel: 0.4 },
  powerKw: 97,
  peakRpm: 8500,
  maxRpm: 8800,
  engageRpm: 4300,
...
export const BEAVER: SledSpec = {
  ...
  treadRear: -1.28,
  lugHeight: 0.038,
  front: { rate: 6400, bump: 440, rebound: 990, travel: 0.19 },
  rear: { rate: 3900, bump: 260, rebound: 530, travel: 0.24 },
  powerKw: 97,
  peakRpm: 7200,
  maxRpm: 7600,
  idleRpm: 1200,
...
export const BISON: SledSpec = {
  ...
  lugHeight: 0.029,
  studs: 0,
  front: { rate: 7000, bump: 420, rebound: 950, travel: 0.23 },
  rear: { rate: 3400, bump: 210, rebound: 490, travel: 0.3 },
  powerKw: 149,
  peakRpm: 8750,
  maxRpm: 9100,
  engageRpm: 3900,
